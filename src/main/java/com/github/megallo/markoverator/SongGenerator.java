...
/**
 * Make songs!
 * Example usage of the Songwriter combined with Markov generation.
 **/

// TODO this is a copy of PoemGenerator, make it real
public class SongGenerator {

    private static final Logger loggie = LoggerFactory.getLogger(SongGenerator.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        SongGenerator pg = new SongGenerator();
