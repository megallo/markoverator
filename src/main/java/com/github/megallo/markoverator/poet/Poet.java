...
public class Poet {
    ...
    private void populatePhonemes(InputStream phonemesStream, InputStream symbolsStream) throws IOException {
        // TODO you can remove the symbol read once you've committed to not using the emphasis markers
...
//                  // TODO wait a sec, I think this was doing the same thing as socher, where I don't remove the number from the vowel. Holy shit
