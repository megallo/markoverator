...
public class RhymerTest {
    ...
    public void testFindRhymes() {
        List<String> actual = rhymer.findRhymingWords("curb");
        ...
        actual = rhymer.findRhymingWords("acts");
    ...
    public void testRhymingSection() {
        ...
        Assert.assertEquals(expected, rhymer.getRhymingSection(input));
    ...
    public void testRhymeLengthOrder() {
        List<String> rhymesOfTomato = rhymer.wordToRhymes.get("tomato");
        ...
        List<String> actual = rhymer.findRhymingWords("tomato");
    ...
    public void testRhymeLengthOrder1000Times() {
        ...
        for (int i = 0; i < 1000; i++) {
            Rhymer localRhymer = new Rhymer(
                    RhymerTest.class.getResourceAsStream(mockDict),
                    RhymerTest.class.getResourceAsStream(realPhones),
                    RhymerTest.class.getResourceAsStream(realSymbols),
                    null);
            List<String> rhymesOfTomato = localRhymer.wordToRhymes.get("tomato");
            List<String> expected = Lists.newArrayList("AHMEYTOW", "AHMAATOW", "MEYTOW", "MAATOW", "EYTOW", "AATOW", "TOW");
    ...
    public void testRemoveWordCounter() {
        Assert.assertEquals("PRESTIGIOUS", rhymer.removeWordCounter("PRESTIGIOUS(1)"));
        Assert.assertEquals("FACTS", rhymer.removeWordCounter("FACTS(1)"));
    }
}
